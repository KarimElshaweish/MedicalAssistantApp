package com.gradproj.medassistant.medicalassistant.GSRReading;
...
public class GSRReading {
     ...
     */
    public static final List<GSRReadingItem> ITEMS = new ArrayList<GSRReadingItem>();

    /**
     * A map of sample (dummy) items, by ID.
     */
    public static final Map<String, GSRReadingItem> ITEM_MAP = new HashMap<String, GSRReadingItem>();
    ...
    static {
        ...
        result = mDBAdapter.fetchAllSensorReadings(SensorType.GSR_SENSOR);
        ...
        if (result.moveToFirst()) {
            do {
                ...
                addItem(new GSRReadingItem(id,reading,date));
    ...
    private static void addItem(GSRReadingItem item) {
        ITEMS.add(item);
     ...
     */
    public static class GSRReadingItem {
        public final String id;
        public final String content;
        public final String details;

        public GSRReadingItem(String id, String content, String details) {
            this.id = id;
