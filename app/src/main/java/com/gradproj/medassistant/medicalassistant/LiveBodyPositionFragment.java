 ...
 */
public class LiveBodyPositionFragment extends ReadingFragment {
...
//    private static DBAdapter mDBAdapter;
    ...
    String readingUnit = "";
    SensorType sensorType = SensorType.BODY_POSITION_SENSOR;
...
//    String suggestedMedicenes = "iBurofen\nAcetaminophen";
    ...
    public LiveBodyPositionFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_live_body_position, container, false);
    }
    ...
    private void updateReading() {
        if(prefs.getBoolean(Constants.POS_KEY,true)){
            ...
            ImageView positionView = getView().findViewById(R.id.body_position);
...
//                textView.setText(reading+readingUnit);
                if(reading.equals("Prone Position"))
                {
                    positionView.setImageDrawable(getView().getResources().getDrawable(R.drawable.prone));
                }else if(reading.equals("Left Latered Position"))
                {
                    positionView.setImageDrawable(getView().getResources().getDrawable(R.drawable.left_lateral));
                }
                else if(reading.equals("Right Latered Position"))
                {
                    positionView.setImageDrawable(getView().getResources().getDrawable(R.drawable.right_lateral));
                }
                else if(reading.equals("Supine Position"))
                {
                    positionView.setImageDrawable(getView().getResources().getDrawable(R.drawable.supine));
                }else if(reading.equals("Stand Or Sit Position"))
                {
                    positionView.setImageDrawable(getView().getResources().getDrawable(R.drawable.sit_up_position));
                }else if(reading.equals("Undefined Position"))
                {
